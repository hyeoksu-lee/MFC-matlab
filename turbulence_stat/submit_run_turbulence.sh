...
/app/matlab/R2023b/bin/matlab -nodisplay -nosplash -nodesktop -r "run('/p/global/hyeoksu/MFC/mixlayer/case/p015-ml3-001/single/turbulence_stat/run_turbulence.m'); exit;"
